...
class Student:
    def __init__(self,root):
       ...
       #Background image
       img3=Image.open(r"C:\Users\ragha\Desktop\Face_Recognition\images\background.jpg")
       ...
       img_left=Image.open(r"C:\Users\ragha\Desktop\Face_Recognition\images\student_detail.jpg")
       ...
       img_right=Image.open(r"C:\Users\ragha\Desktop\Face_Recognition\images\stu.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.va_std_id.get()=="" or self.var_std_name.get()=="":
            messagebox.showerror("Error","All fields are required",parent=self.root) 
        else:
            try:
                conn = mysql.connector.connect(host="localhost",user="root",password="Abcd@1234",database="face_recognizer")   #,auth_plugin = "mysql_native_password"
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.va_std_id.get()=="" or self.var_std_name.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Generating data sets complete successfully",parent=self.root)  #parent
